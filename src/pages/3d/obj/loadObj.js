...
import getDDSLoader from '@/common/jsm/loaders/DDSLoader.js';
import getMTLLoader from '@/common/jsm/loaders/MTLLoader.js';
import getOBJLoader from '@/common/jsm/loaders/OBJLoader.js';
...
export default function (canvas, THREE) {
    ...
    function init() {
        ...
        let texture = textureLoader.load('http://static.card.nmgjoin.com/three/textures/uv_grid_opengl.jpg');
        ...
        loader.load('http://static.card.nmgjoin.com/three/models/obj/male02/male02.obj', function (obj) {
