<template>
    ...
    <u-keyboard ref="uKeyboard" v-model="show" @change="change" @backspace="backspace"></u-keyboard>
	</view>
</template>
    ...
    onLoad(options={}) {
      ...
      change(e) {
        ...
        if (isExistRadix && e == '.') {
          ...
          let lastNewStr = newStr.indexOf(".") === -1 ?  newStr : newStr.substring(0, newStr.indexOf(".") + 3)
          this.val  = lastNewStr
        }
