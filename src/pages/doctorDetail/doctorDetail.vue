<template>
  <view class="wrap">
    <view class="wrap__user">
      ...
      <view class="info">
        <view class="title">
          <view class="name">特木其勒</view>
          <view class="share">
            <view class="share_icon">
              <image class="img" mode="widthFix" src="@/static/image/doctor_d_icon1.png" />
            </view>
            <view class="share_icon">
        ...
        <view class="subt">
          <view class="subt-zc">职称：主任医师</view>
          <view class="subt-zw">职务：科室主任</view>
        </view>
        <view class="intr">擅长：以蒙医针灸五疗治疗疾病见长，并把针灸超长的应用到内、外、妇、儿科。</view>
      </view>
    </view>
